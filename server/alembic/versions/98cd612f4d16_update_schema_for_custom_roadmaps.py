"""Update schema for custom roadmaps

Revision ID: 98cd612f4d16
Revises: 
Create Date: 2026-03-24 19:45:22.396718
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_topic_connections_id'), 'topic_connections', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_topic_connections_id'), table_name='topic_connections')
